...
INSERT INTO BUG (title,description,status_code,importance_code,created_on,created_by,updated_on,updated_by) VALUES  ('Functionality','Status cannot have provided data','NEW','HGH',CURRENT_DATE()-1,'admin',CURRENT_DATE(),'admin');
...
INSERT INTO BUG (title,description,status_code,importance_code,created_on,created_by,updated_on,updated_by) VALUES  ('Functionality','3-Status cannot have provided data','NEW','HGH',CURRENT_DATE()-2,'admin',CURRENT_DATE(),'admin');
...
INSERT INTO BUG (title,description,status_code,importance_code,created_on,created_by,updated_on,updated_by) VALUES  ('Functionality','6-Status cannot have provided data','NEW','HGH',CURRENT_DATE()-3,'admin',CURRENT_DATE(),'admin');
...
INSERT INTO BUG (title,description,status_code,importance_code,created_on,created_by,updated_on,updated_by) VALUES  ('Functionality','10-bug number format is not correct','CLR','MED',CURRENT_DATE()-4,'admin',CURRENT_DATE(),'admin');
...
INSERT INTO BUG (title,description,status_code,importance_code,created_on,created_by,updated_on,updated_by) VALUES  ('Functionality','12-Status cannot have provided data','NEW','HGH',CURRENT_DATE()-1,'admin',CURRENT_DATE(),'admin');
